...
/* Full-bleed 16:9 image zone — no padding, cover fill */
.sp-img-zone{
  position:relative;
  width:100%;
  aspect-ratio:16/9;
...
/* Subtle color glow behind the image */
.sp-glow{
  position:absolute;
  inset:0;
  pointer-events:none;
...
/* Cover image — fills the entire zone */
.sp-cover{
  position:absolute;
  inset:0;
  width:100%;
...
/* Gradient overlay at bottom — creates smooth transition to card body */
.sp-img-fade{
  position:absolute;
...
/* Label badge — now sits in card body, not overlapping the photo */
.sp-label{
  display:inline-flex;
  align-items:center;
...
/* Kit preview zone — fills top of the right panel */
.pm-kit-zone{
  position:relative;
  width:100%;
  aspect-ratio:1/1;
                ...
                <div className="sp-grid">
                  {PACKS.map((pk, idx) => (
                    ...
                    >
                      ...
                      {/* Card body — label badge moved here */}
        ...
        <div className="ov" onClick={() => setPackModal(null)}>
          ...
          >
            ...
            >
              ...
              {/* RIGHT — kit preview fills the panel */}
              <div className="pm-right">
                {/* Kit image — square, fills top */}
