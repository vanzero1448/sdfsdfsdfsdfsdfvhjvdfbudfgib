...
const STARTER_PACKS = [
  {
    ...
    description:
      "Everything a new player needs. The Novice Pack gives you a head-start with Ping rank for 3 months, a hand-crafted starter kit, and cosmetic items to make your character stand out from day one.",
    kitDescription:
      "The Novice Kit includes a full set of iron gear, 64 food, starter tools, and 500 coins — enough to establish yourself in the first hours of play.",
    includes: [
      "Ping rank — 3 Months",
  ...
  },
  {
    ...
    description:
      "The most popular choice. Packet rank for life means you never pay again — plus you get flight, freecam, and a powerful kit that gives you a real edge over the competition.",
    kitDescription:
      "The Pro Kit packs diamond tools, enchanted armor, a full food stack, 2,500 coins, and an exclusive cosmetic banner — a serious advantage from the first minute.",
    includes: [
  ...
  },
  {
    ...
    description:
      "The ultimate starter bundle. Sponsor Pack grants Protocol rank for life, giving you god mode, inventory inspection, and the moonwalk — plus the richest kit on the server. One purchase, lifetime power.",
    kitDescription:
      "The Sponsor Kit contains a full set of enchanted netherite gear, elytra, 7,500 coins, and a unique Sponsor cosmetic title that marks you as a true backer of the project.",
    includes: [
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ─── NICK INPUT ─── */
        .nick-wrap { margin-bottom: 20px; }
        .nick-label {
          font-family: var(--fm); font-size: 9px; font-weight: 600; letter-spacing: .13em;
          text-transform: uppercase; color: var(--t3); margin-bottom: 8px; display: block;
        }
        .nick-input {
          width: 100%; padding: 12px 14px; border-radius: 8px;
          background: var(--s2); border: 1px solid var(--w2);
          color: var(--t1); font-family: var(--fb); font-size: 14px; font-weight: 500;
          outline: none; transition: border-color .2s;
        }
        .nick-input::placeholder { color: var(--t3); }
        .nick-input:focus { border-color: var(--w3); }

        /* ─── PACK MODAL SPECIFIC ─── */
        .pm-img-zone {
          position: relative; background: var(--s2); border-bottom: 1px solid var(--w);
          display: flex; flex-direction: column; align-items: center;
          justify-content: center; padding: 32px 24px 26px; gap: 18px;
        }
        .pm-imgs { display: flex; align-items: flex-end; justify-content: center; gap: 24px; }
        .pm-pack-img { width: 90px; height: 90px; object-fit: contain; }
        .pm-kit-img {
          width: 110px; height: 110px; object-fit: contain;
          filter: drop-shadow(0 8px 24px rgba(0,0,0,.6));
        }
        .pm-sep { width: 1px; height: 60px; background: var(--w); }
        .pm-kit-label {
          font-family: var(--fm); font-size: 9px; letter-spacing: .12em; text-transform: uppercase; color: var(--t3);
        }
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="m-pad">
              ...
              <div className="nick-wrap">
                <label className="nick-label">Your Minecraft nickname</label>
                <input
                  ...
                  style={{
                    borderColor: nickname ? selected.color + "55" : undefined,
                  }}
                />
              </div>
      ...
      {/* ── STARTER PACK MODAL ── */}
      {selectedPack && (
        <div className="ov" onClick={() => setSelectedPack(null)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div
              className="m-stripe"
            ...
            <div className="pm-img-zone">
              <div className="pm-imgs">
                <div style={{ textAlign: "center" }}>
                  ...
                  />
                  <div className="pm-kit-label" style={{ marginTop: 8 }}>
                    Pack
                  </div>
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: selectedPack.color + "40",
                  background: selectedPack.color + "0c",
                }}
              >
                {selectedPack.label}
              </div>
            ...
            <div className="m-pad">
              <div className="m-top">
                <div>
                  <div
                    className="m-rname"
                    style={{ color: selectedPack.color }}
                  >
                    {selectedPack.name} Pack
                  </div>
                  <div className="m-rtag">{selectedPack.tagline}</div>
                </div>
                <button
                  className="m-close"
              ...
              <div className="m-desc">{selectedPack.description}</div>

              <div className="m-lbl">Kit contents</div>
              <div className="m-desc" style={{ marginBottom: 22 }}>
                {selectedPack.kitDescription}
              </div>

              <div className="m-lbl">What's included</div>
              <div className="m-perks" style={{ marginBottom: 22 }}>
                {selectedPack.includes.map((item) => (
                  <div key={item} className="m-perk">
                    <div
                      className="m-dot"
                      style={{ background: selectedPack.color }}
                    />
                    <span style={{ color: "var(--t1)" }}>{item}</span>
                  </div>
                ))}
              </div>
              ...
              >
                <Package size={14} />
                Purchase {selectedPack.name} Pack · ${selectedPack.price}
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="m-pad">
              ...
              <div className="m-desc">
                ...
                badge. Once purchased it's yours for the entire season. The
                highest-value item in the store.
              </div>
              ...
              <div className="nick-wrap">
                ...
                <input
                  ...
                  onChange={(e) => setNickname(e.target.value)}
                  style={{
                    borderColor: nickname ? "rgba(124,92,252,.55)" : undefined,
                  }}
                />
              </div>
