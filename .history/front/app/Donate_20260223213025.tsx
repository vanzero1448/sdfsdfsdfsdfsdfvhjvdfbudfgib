...
// ── Images ──────────────────────────────────────────────────────
import heroDonate from "@/assets/img/herodonate.png";
import bpImg from "@/assets/img/ranks/bp.png";

import rankPing from "@/assets/img/ranks/ping.png";
import rankPacket from "@/assets/img/ranks/packet.png";
import rankProtocol from "@/assets/img/ranks/protocol.png";
import rankScript from "@/assets/img/ranks/script.png";
import rankKernel from "@/assets/img/ranks/kernel.png";
import rankCipher from "@/assets/img/ranks/cipher.png";
import rankQuantum from "@/assets/img/ranks/quantum.png";
import rankCore from "@/assets/img/ranks/core.png";
import rankOverclock from "@/assets/img/ranks/overclock.png";
import rankSingularity from "@/assets/img/ranks/singularity.png";

import s1 from "@/assets/img/starter/s1.png";
import s2 from "@/assets/img/starter/s2.png";
import s3 from "@/assets/img/starter/s3.png";
import k1 from "@/assets/img/starter/k1.png";
import k2 from "@/assets/img/starter/k2.png";
import k3 from "@/assets/img/starter/k3.png";

import cosEmber from "@/assets/img/cosmetics/ember_dragon.png";
...
const PACKS = [
  ...
  },
  {
    ...
    kitImg: k3,
    description:
      "The ultimate starter bundle. Protocol rank for life grants god mode, inventory inspection, the moonwalk — plus the richest kit on the server. One purchase, lifetime power.",
    kitDescription:
      "Full enchanted netherite gear, elytra, 7,500 coins, and a unique Sponsor cosmetic title that marks you as a true backer of the project.",
    includes: [
...
.eyebrow{display:inline-flex;align-items:center;gap:10px;
  font-family:var(--fm);font-size:10px;color:var(--t3);letter-spacing:.15em;text-transform:uppercase;margin-bottom:20px}
...
/* BATTLE PASS */
.bp{border:1px solid var(--w);border-radius:14px;overflow:hidden;
  background:var(--s1);margin-bottom:72px;cursor:pointer;transition:border-color .3s}
...
.bp-chip{display:inline-flex;align-items:center;gap:5px;font-family:var(--fm);
  font-size:9px;letter-spacing:.16em;text-transform:uppercase;color:var(--t3);
...
.bp-tag{display:flex;align-items:center;gap:7px;border:1px solid var(--w);
  border-radius:5px;padding:5px 12px;font-size:11px;color:var(--t2)}
.bp-dot{width:4px;height:4px;border-radius:50%;background:rgba(124,92,252,.85);flex-shrink:0}
.bp-cta{display:inline-flex;align-items:center;gap:8px;padding:11px 20px;border-radius:7px;
  cursor:pointer;border:1px solid rgba(124,92,252,.3);background:rgba(124,92,252,.09);
...
/* PERIOD SWITCHER */
.psw{position:relative;display:inline-flex;background:var(--s2);
  border:1px solid var(--w);border-radius:7px;padding:3px;gap:2px}
.psw-bg{position:absolute;top:3px;bottom:3px;left:0;background:var(--s3);
  border:1px solid var(--w2);border-radius:5px;pointer-events:none;
...
.psw-btn{position:relative;z-index:1;padding:7px 16px;border:none;background:transparent;
  cursor:pointer;font-family:var(--fb);font-size:12px;font-weight:600;
  border-radius:4px;transition:color .25s;white-space:nowrap}
...
.sp-img-zone{position:relative;background:var(--s2);border-bottom:1px solid var(--w);
  ...
  padding:36px 24px 28px;min-height:180px}
.sp-glow{position:absolute;width:120px;height:120px;border-radius:50%;
  filter:blur(48px);opacity:.15;top:50%;left:50%;
...
.sp-btn{width:100%;padding:12px;border-radius:7px;border:1px solid;
...
.cc-btn{width:100%;padding:10px;border-radius:7px;border:1px solid;
  font-family:var(--fb);font-size:12px;font-weight:600;cursor:pointer;background:transparent;transition:opacity .2s}
...
/* modal layout: left = scroll content, right = sticky image */
.m-body{display:grid;grid-template-columns:1fr 200px}
@media(max-width:560px){.m-body{grid-template-columns:1fr}}
.m-left{padding:26px;border-right:1px solid var(--w);overflow:hidden}
@media(max-width:560px){.m-left{border-right:none}}
.m-right{padding:24px 18px;display:flex;flex-direction:column;align-items:center;
  gap:14px;background:var(--s2);position:sticky;top:0;align-self:start;
  border-radius:0 18px 18px 0}
@media(max-width:560px){.m-right{display:none}}
.m-right-img{width:130px;height:130px;object-fit:contain}
.m-right-label{font-family:var(--fm);font-size:9px;letter-spacing:.12em;
...
.m-close{background:var(--s2);border:1px solid var(--w);border-radius:7px;
  padding:6px;cursor:pointer;color:var(--t3);line-height:1;flex-shrink:0;transition:border-color .2s}
...
.m-pbtn{position:relative;z-index:1;padding:12px 8px;border-radius:8px;
  cursor:pointer;font-family:var(--fb);border:1px solid var(--w);
  background:var(--s2);text-align:center;transition:color .22s,border-color .22s}
...
.m-perk{display:flex;align-items:center;gap:10px;padding:9px 12px;
  background:var(--s2);border-radius:7px;font-size:13px}
.m-dot{width:4px;height:4px;border-radius:50%;flex-shrink:0}
.m-cmds{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:20px}
.m-cmd{font-family:var(--fm);font-size:11px;padding:4px 9px;
...
.m-buy{width:100%;padding:14px;border-radius:10px;border:none;
...
.m-buy:hover:not(:disabled){filter:brightness(1.1)}

/* BP modal kit-only zone */
.bp-kit-zone{display:flex;flex-direction:column;align-items:center;justify-content:center;
  padding:32px 18px;background:var(--s2);gap:10px}
.bp-kit-img{width:100px;height:100px;object-fit:contain}
.bp-kit-lbl{font-family:var(--fm);font-size:9px;letter-spacing:.12em;text-transform:uppercase;color:var(--t3)}
              ...
              <div className="hero-layout">
                <div className="hero-text">
                  ...
                  <p className="hero-p">
                    ...
                    your presence felt across the world. Every purchase funds
                    development.
                  </p>
                </div>
                <div className="hero-img-wrap">
                  <div className="hero-glow" />
                  <img className="hero-char" src={heroDonate} alt="hero" />
                </div>
              </div>
            </div>
                ...
                <div className="bp" onClick={openBp}>
                  ...
                  <div className="bp-layout">
                    ...
                    <div className="bp-right">
                      <img className="bp-img" src={bpImg} alt="bp" />
                      <div>
            ...
            <div className="m-body">
              <div className="m-left">
                ...
                <div className="nick-wrap">
                  ...
                  <input
                    ...
                    style={{
                      borderColor: nick ? rankModal.color + "55" : undefined,
                    }}
                  />
                </div>
                <button
                  className="m-buy"
                  style={{
                    background: rankModal.color,
                    opacity: nick.trim() ? 1 : 0.45,
              ...
              <div className="m-right">
                <img
                  ...
                  alt={rankModal.name}
                />
                <div className="m-right-label">{rankModal.name} Rank</div>
            ...
            <div className="m-body">
              <div className="m-left">
                ...
                <div className="nick-wrap">
                  ...
                  <input
                    ...
                    onChange={(e) => setNick(e.target.value)}
                    style={{
                      borderColor: nick ? packModal.color + "55" : undefined,
                    }}
                  />
                </div>
                <button
              ...
              <div className="m-right">
                ...
                >
                  ...
                  />
                  <div className="m-right-label">Pack</div>
                  <div
                    style={{ width: "100%", height: 1, background: "var(--w)" }}
                  />
                  <img
                  ...
                  />
                  <div className="m-right-label">Exclusive Kit</div>
                </div>
                <div style={{ marginTop: "auto", textAlign: "center" }}>
                  <div
                    style={{
            ...
            <div className="m-body">
              <div className="m-left">
                <div className="m-top">
                  ...
                  <button className="m-close" onClick={() => setBpModal(false)}>
                    <X size={15} />
                  </button>
                </div>
                ...
                <div className="nick-wrap">
                  ...
                  <input
                    ...
                    onChange={(e) => setNick(e.target.value)}
                    style={{
                      borderColor: nick ? "rgba(124,92,252,.55)" : undefined,
                    }}
                  />
                </div>
                <button
              ...
              <div className="m-right">
                ...
                />
                <div className="m-right-label">Battle Pass</div>
                <div style={{ marginTop: "auto", textAlign: "center" }}>
                  <div
                    style={{
                      fontFamily: "var(--fh)",
