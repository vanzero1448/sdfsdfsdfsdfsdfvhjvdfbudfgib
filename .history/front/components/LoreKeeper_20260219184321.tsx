  ...
  const [msgs, setMsgs] = useState<ChatMessage[]>([
    {
      id: "0",
      role: "model",
      text: "Привет! Я — Хранитель Льда. Задай вопрос об IceTale.",
      timestamp: new Date(),
    },
  ]);
      ...
      {!open && (
        <div className="chat-toggle">
          <button
            ...
            style={{ boxShadow: "0 8px 24px rgba(59,130,246,.4)" }}
            onClick={() => setOpen(true)}
          >
            <Snowflake size={15} /> Хранитель
          </button>
        </div>
      )}
      ...
      {open && (
        <div className="chat-window">
          ...
          >
            ...
            {loading && (
              <div className="chat-bubble-bot" style={{ color: "var(--t3)" }}>
                Думаю...
              </div>
            )}
            <div ref={endRef} />
          ...
          >
            ...
            <button
              ...
              disabled={loading}
              className="btn btn-blue"
              style={{ padding: "9px 12px", minWidth: "auto" }}
            >
              <Send size={14} />
            </button>
          </div>
