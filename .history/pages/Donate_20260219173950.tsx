    ...
    <div className="py-12 px-4 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl text-white mb-6 text-shadow-pixel">
            МАГАЗИН СЕРВЕРА
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {ranks.map((rank) => (
            <div key={rank.id} className="relative group w-full h-full">
              ...
              <div
                className={`pixel-box p-0 h-full flex flex-col ${rank.popular ? "border-yellow-400 shadow-[12px_12px_0px_rgba(250,204,21,0.2)]" : ""}`}
              >
                {/* Header */}
                <div
                  className={`${rank.color} p-6 border-b-4 border-black text-center relative overflow-hidden`}
                >
                  ...
                  <h3
                    className="text-3xl text-white text-shadow-pixel mb-2"
                ...
                <div className="p-8 bg-slate-800 flex-grow flex flex-col justify-between">
                  <ul className="space-y-4 mb-8">
                    {rank.features.map((feature, idx) => (
                      <li
                        key={idx}
                        className="flex items-start gap-3 text-gray-300 text-xl"
                      >
                        <div className="mt-1">
