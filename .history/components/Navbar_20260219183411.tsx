        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="hidden sm:block">
              <span
                className="text-3xl font-black tracking-[-2px] text-white neon-cyan"
                style={{ fontFamily: '"Press Start 2P"' }}
              >
                ICE<span className="text-cyan-400">TALE</span>
              </span>
              <p className="text-[10px] text-cyan-400 -mt-1 tracking-[4px]">
                Hytale SERVER
              </p>
            </div>
          </div>
              ...
              <button
                ...
                className={`block w-full text-left px-6 py-5 text-2xl border-l-4 transition-all ${
                  currentPage === item.page
                    ...
                    : "border-transparent text-slate-300 hover:text-cyan-400 hover:bg-slate-900/30"
                }`}
              >
                {">"} {item.label}
              </button>
